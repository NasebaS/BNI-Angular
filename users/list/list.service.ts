...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.firstName.toLowerCase().includes(term.toLowerCase())
        || tables.emailId.toLowerCase().includes(term)
        || tables.mobile.toLowerCase().includes(term)
        || tables.gender.toLowerCase().includes(term)
        || tables.dob.toLowerCase().includes(term)
        || tables.claims.toLowerCase().includes(term)
